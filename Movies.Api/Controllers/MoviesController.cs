...
public class MoviesController : ControllerBase
{
	...
	public const string OutputCachePolicyName = "MovieCache";
	public const string OutputCacheTagName = "movies";
    ...
    public async Task<IActionResult> Create([FromBody] CreateMovieRequest request, CancellationToken token)
	{
		...
		await _outputCacheStore.EvictByTagAsync(OutputCacheTagName, token);
		return CreatedAtAction(nameof(Get), new { idOrSlug = movie.Id }, movie);
	}

	[HttpGet(ApiEndpoints.Movies.Get)]
    [OutputCache(PolicyName = OutputCachePolicyName)]
